...
def build(root=ROOT):
    ...
    _csv(out/"v5_1_1_energy.csv",pick(econ,["project_id","country","installed_capacity_kwp_observed","generation_p50_kwh_observed","generation_p50_kwh_modeled","specific_yield_observed","generation_p90_kwh","generation_p99_kwh","specific_yield_p50_kwh_kwp","specific_yield_p90_kwh_kwp","specific_yield_p99_kwh_kwp","p50_p90_p99_method"]),["project_id","country","installed_capacity_kwp_observed","generation_p50_kwh_observed","generation_p50_kwh_modeled","specific_yield_observed","generation_p90_kwh","generation_p99_kwh","specific_yield_p50_kwh_kwp","specific_yield_p90_kwh_kwp","specific_yield_p99_kwh_kwp","p50_p90_p99_method"])
