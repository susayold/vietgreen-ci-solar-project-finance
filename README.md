...
The Python and CSV logic is the source of truth. The native workbook and compressed hourly streams are remote artifacts regenerated by workflow from repository contents.
